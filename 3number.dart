void main() {
  ...
  //jika pada tipe data  int kita masukan nilainy dengan angka desimal, maka akan error (seperti di bawah ini)
  // int angkaError = 25.0;
  ...
  double angka4 = 25.6;
  double angka5 = 17; // saat di cetak akan menghasilkan 17.0
  ...
  //pembulatan
  print("Nilai angka6 = ${angka6.ceil()}"); //pembulatan nail
}
